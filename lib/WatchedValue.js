...
WatchedValue.prototype._updated = function () {};
      ...
      comparable = ComparableInjector.map(function (callback, implementation) {
        return function () {
          var comparison = utilities.attach(implementation, this,
              ...
              updated = watchedValue._updated;
              
          if (comparison()) {
            deferred.resolve(watchedValue.value());
          }
          else {
            watchedValue._updated = function () {
              updated.call(watchedValue);
      ...
      comparable = ComparableInjector.map(function (callback, implementation) {
        return function () {
          ...
          if (! comparison()) {
            ...
            watchedValue._updated = function () {
              updated.apply(watchedValue, arguments);
